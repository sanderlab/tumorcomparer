...
#' 
#' @export 
tc_geneset_comparison <- function(gene_list, cancer_type, 
                                    tc_dataset=NULL, 
                                    tc_dataset_dir=NULL, 
  ...
  intersect(colnames(mut_mat_CCLP_after_Annovar), CCLP_TCGA_Types_Combined$Model_name[which(CCLP_TCGA_Types_Combined$TCGA_Type == cancer_type)])
